 ...
 * import com.cbo.customerlist.data.Clientes
 * import com.cbo.customerlist.data.ClientesProvider
 * import com.moronlu18.customerlist.databinding.ActivityCustomerListBinding
 *
 * class CustomerList1 : AppCompatActivity() {
 *
 ...
 *     }
 *     fun onItemSelected1(cliente: Clientes) {
 *         Toast.makeText(this,cliente.name, Toast.LENGTH_SHORT).show()
 *
 *     }
 * }
 */