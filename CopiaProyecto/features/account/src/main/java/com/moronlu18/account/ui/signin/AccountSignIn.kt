...
import com.moronlu18.account.ui.singin.AccountSignInDirections
...
class AccountSignIn : Fragment() {
    ...
    private fun showMessage(message: String) {
        ...
        val action =
            AccountSignInDirections.actionAccountSignInToBaseFragmentDialog("Error", message)
        //Navegamos al dialog
    ...
    private fun showMessageCorrect(cuenta: Account) {
        //Toast.makeText(requireContext(), "Mi primer MVVM $message", Toast.LENGTH_SHORT).show()
        val action =
            AccountSignInDirections.actionAccountSignInToBaseFragmentDialog("Éxito", cuenta.email.toString())
        //Navegamos al dialog
        findNavController().navigate(action)
